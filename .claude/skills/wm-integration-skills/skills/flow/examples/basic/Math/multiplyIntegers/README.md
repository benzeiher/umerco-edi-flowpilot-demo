...
## Purpose
Demonstrates basic integer multiplication by using the `pub.math:multiplyInts` service.

## Implementation
- The service accepts two string inputs: `num1` and `num2`
- Invokes `pub.math:multiplyInts` by using direct parameter mapping
- Returns the multiplication result as a string 
...
**Output:**
- `result` (String): Product of `num1` and `num2`
